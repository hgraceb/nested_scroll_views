...
/// ```
/// {@end-tool}
class FlutterPageController extends ScrollController {
  /// Creates a page controller.
  ///
  /// The [initialPage], [keepPage], and [viewportFraction] arguments must not be null.
  FlutterPageController({
    this.initialPage = 0,
    this.keepPage = true,
...
final FlutterPageController _defaultPageController = FlutterPageController();
...
class FlutterPageView extends StatefulWidget {
  ...
  FlutterPageView({
    ...
    this.reverse = false,
    FlutterPageController? controller,
    this.physics,
  ...
  /// view is scrolled.
  final FlutterPageController controller;
...
class FlutterPageViewState extends State<FlutterPageView> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(DiagnosticsProperty<FlutterPageController>('controller', widget.controller, showName: false));
